...
var writeClientConfig = function(config){
  ...
  client_config = `app.value('configDetails',${JSON.stringify(client_config)});`;
  fs.writeFileSync('./src/app/components/configDetails/configDetailsConstant.js',client_config);
}
